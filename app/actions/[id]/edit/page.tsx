...
export default async function EditPostServerActionPage({
  ...
  return (
    <main className="p-6 max-w-xl mx-auto">
      ...
      {/* FORMULARZ EDIT — wysyła dane do updatePostAction */}
      <form action={updatePostAction} className="space-y-4">
        {/* ID przekazywane ukryte */}
        ...
        <button className="px-4 py-2 bg-yellow-500 text-white rounded hover:bg-yellow-400 transition">
          Zapisz zmiany
        </button>
      </form>
